...
In a
[previous post](/posts/driving-stepper-motors-with-microcontroller)
...
![Viewing the CAD files in OpenCAD](/posts/writing-a-gear-torque-calculator/media/gear_in_opencad.png)
