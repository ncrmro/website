...
slug: scheduled-ci-e2e-test-failure-slack-notification
date: 2021-03-24
published: true
tags: ["technical"]
---
...
![A Slack message showing which E2E tests failed, what CI job they failed on, the total time, and the error count.](/posts/scheduled-ci-e2e-test-failure-slack-notification/media/slack-notification-for-failed-e2e-tests.jpg)
