...
values  ('039862ea-7914-4913-a1e7-3b0f77b990ef', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Alpine k3s based single node Kubernetes cluster.', '
...
```
', 'This guide shows how to set up a Kubernetes node with Alpine', 'alpine-k3s', 1, '2021-02-07', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('0ac3c93a-31fa-45e6-9ee3-6c43cccd45dd', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Compiling and Testing on a remote microcontroller', '
...
...
```
', 'We learn how we can develop microcontroller code using the Arduino CLI, compile it and the upload our code to the micrcontroller.', 'developing-on-remote-microcontroller', 1, '2020-06-24', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('0f613cfe-2264-4249-838f-9a7b14a44790', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Choosing the best multi-OS setup with PCIe device passthrough', '
...
', 'In this post I discuss my experience with my Linux workstations that use a technology called PCIe passthrough to use a dedicated GPU for gaming in a Windows Guest.', 'choosing-the-best-multi-os-setup', 1, '2022-12-21', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('0f9e4d84-987c-4742-81e4-328b847ab6e0', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Project Quiescent', '
...
', 'A new project i''m working on to build better blogs that live inside of git.', 'quecent', 1, '2022-07-27', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('158418c3-7a5c-445d-b390-c223092de374', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'India Part 1 - Arrival and PyCon India', '
...
## Dinner after words
', 'The beginning of my trip to India.', 'india-1', 0, '2017-11-01', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('2c955b50-89a6-4164-aabe-140405882375', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'New site stack', '
...
', 'We take a look at the process and technology behind this site.', 'new-site-stack', 1, '2019-03-10', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('49754cfb-ced6-484e-bd05-85649e939f39', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Typescript React Grid Areas', '
...
Hope you enjoyed!
', 'A Reusable Component Design Pattern for CSS Grid Areas in Typescript React.', 'typescript-react-grid-areas', 1, '2020-12-17', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('51bcc23d-9f1b-4c58-b60f-279c59f5817d', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Getting your Heart in Redzone', '
...
', 'How to train for Vo2 max using the Apple Watch.', 'vo2-max-training-with-apple-watch', 1, '2022-11-20', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('59b3a5eb-e984-4d1c-a46c-5063c773dd86', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Driving a stepper motor with a microcontroller', '
...
', 'Controlling a stepper motor.', 'driving-stepper-motors-with-microcontroller', 1, '2020-06-16', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('5b19f212-edba-4bd2-a03b-2a3d26c9b1f0', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Summertime Adventure in New Orleans', '
...
', 'Visiting New Orleans with my friend Andy', 'summertime-adventure-new-orleans', 1, '2022-07-16', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('6662501f-3970-4e2c-83a3-d2e65852a707', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Mount Kilimanjaro Part 1 - Getting ready', '
...
', 'Origin''s of my Tanzania Africa trip to climb Kilimanjaro to raise funds for the Arizona Burn center.', 'kilimanjaro-1-two-weeks-before', 1, '2022-06-01', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('6d2d8026-ab9a-45bc-99ff-16d1f5b85843', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Evaluating Rust.', '
...
', 'A look at setting using Rust for REST APIs and Embedded development.', 'evaluating-rust', 1, '2020-06-15', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('73caa957-2222-4a9a-bc2f-9cd26a893d53', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Gondola', '
...
', 'Ansible Playbook for Emulating Raspberry Pi OS with KVM', 'gondola-ansible-playbook-for-emulating-raspberry-pi-os-with-kvm', 1, '2020-07-22', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('903c956e-ae50-42d5-9958-8f0f6b0a650e', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Apollo Cache Overview', '
...
', 'What is the Apollo cache, ensure correct usage and update post mutation.', 'apollo-cache-overview', 1, '2021-01-02', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('9b8db018-860e-4a78-9881-5fafc9e3e075', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Multi Arch Docker Buildx in CI/CD', '
...
', 'Automated Multi Arch Docker Image Builds', 'multi-arch-docker-buildx-ci-cd', 1, '2020-08-14', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('9f1741f1-f63d-4d33-8491-f7dcf934bda7', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Learning network security with IoT/HomeKit.', '
...
', '"How setting up IoT/HomeKit can teach you about network security."', 'how-homekit-led-to-learning-about-network-security', 1, '2019-04-15', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('a19378a1-7e66-414a-b09d-8beabda57ea6', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Docker Linux Workstation Development', '
...
```
', 'Making linux Docker more like Docker Desktop for macOS and Windows.', 'docker', 1, '2021-02-06', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('a1a0acc5-8c60-40e7-8aa5-63ccd1552341', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Straight forward reusable React components', '
...
```
', 'Building clean reusable components and avoiding decision paralysis when choosing their props.', 'straight-forward-reusable-components', 1, '2022-02-02', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('b6ff59cd-aebd-43a9-b348-68085d6b6c58', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Building a scheduled CI E2E test failure Slack notifier', '
...
notifier();
```
', 'How to build a Slack notifier when scheduled E2E tests fail.', 'scheduled-ci-e2e-test-failure-slack-notification', 1, '2021-03-24', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('c54df77b-9dc5-4213-b3ec-6edf70978273', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Scytale: Ansible Automated Private Key Infrastructure.', '
...
', 'Automated private key infrastructure (PKI), Ansible managed certificate authority, server and client certificates.', 'scytale-automated-private-key-infrastructure', 1, '2020-08-23', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('d5955e6a-e343-4c80-a24c-140764e5d7d5', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Rsync''ing Code Directories Between two computers', '
...
```
', 'A script to attempt keeping my code folder in sync between my laptop and workstation.', 'rsync-code-directories', 1, '2020-12-04', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('d9506cc6-90e3-433f-82be-d78fa203083d', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Writing a gear torque calculator', '
...
', 'While utilizing a stepper motor and gears. I needed more torque and different sized gears. So I wrote a small gear torque calculator.', 'writing-a-gear-torque-calculator', 1, '2020-07-02', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('dbd8b1bb-53a9-4129-b3c5-73f09388eb6c', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Building a Enum Based Form Stepper In React Typescript', '
...
```
', 'We look at a streamlined form stepper design pattern.', 'typescript', 1, '2021-01-18', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('e023614d-3161-41a9-86c6-6300f7f39b25', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Last Vegas Evo 2022', '
', 'TODO', 'las-vegas-evo-2022', 0, '2022-08-08', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('e7124b42-8c06-43a3-9b1b-be08a80cfda1', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Contemplating Dunning-Kruger.', '
...
', 'I''ve been contemplating the Dunning-Kruger effect and it''s caused a bit of anxiety. ', 'contemplating', 1, '2022-12-13', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('e90ec984-bc34-4f1c-890a-18398326acc2', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Hello World - 2019', '

A simple blog post to test the codebase this site is built on.
', 'A simple blog post to test the codebase this site is built on.', 'hello-world-2019', 0, '2019-03-07', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('f21bcac2-8648-4c59-a5a6-f7aa81c1a7b6', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Wireguard Based VPN Intranets', '
...
', 'Understanding and Implementing Private Intranets', 'wireguard-based-vpn-intranets', 1, '2021-01-07', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('fb798820-e499-4295-835d-1a6682e320c1', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'Backing up ZFS snapshots remotely without root access', '
', 'TODO', 'backing-up-zfs-snapshots-remotly-without-root', 0, '2022-08-10', '2023-08-03 20:56:22', '2023-08-03 20:56:22'),
        ('fe353c74-07bb-4db7-b938-b6f7b8d44f43', 'ca55d247-66e2-4346-b130-06c2d5a7c826', 'MacOS fast user switching.', '
...
', 'Use fast user switching for hygienic separation between personal and professional accounts on a single laptop.', 'macos-fast-user-switching', 1, '2019-04-09', '2023-08-03 20:56:22', '2023-08-03 20:56:22');